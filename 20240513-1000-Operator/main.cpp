...
public:
    ...
    SonData() {
        cout << "기본 생성자 호출" << endl;
        _name = "없음";
        _gender = 3; // 0은 여자, 1은 남자   // 성별
        _weight = 0.0f;   // 몸무게
        _height = 0.0f;   // 키
        _beforeTeam = "없음";   // 이전 팀
        _position = 0;   // 0: forward, 1: midfield....
        _mainFoot = true;   // true: 오른발, false: 왼발
        _nationality = "없음";   // 국적
        _homeGround = "없음";   // 홈그라운
        _skill = "없음";    // 스킬
        ...
        int position, bool mainFoot, string nationality, string homeGround, string skill)
    {
        ...
        _weight = weight; // 몸무게
        _height = height;   // 키
        _beforeTeam = beforeTeam;   // 이전 팀
        _position = position; // 0: forward, 1: midfield....
        _mainFoot = mainFoot;   // true: 오른발, false: 왼발
        _nationality = nationality;   // 국적
        _homeGround = homeGround;   // 홈그라운
        _skill = skill;    // 스킬
    }
